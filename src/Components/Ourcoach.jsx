...
function Ourcoach({ coach }) {
  return (
    <section className="updown-space" style={{backgroundColor:"rgb(0 0 0 / 91%)"}}>
      <div className="container position-relative">
        <div className="getknow d-flex justify-content-center align-items-center gap-3">
          ...
          <div className="gt-title">
            <h4 className="m-0 text-light">Our Coaches</h4>
          </div>
        </div>

        <div className="Guided-title text-light text-center">
